...
PREGUNTAS_DATA = [
    ...
    {"id": 6, "texto_pregunta": "En una escala de 1 a 10, ¿qué tan preocupado/a estás por el bienestar del niño/a?", "tipo_respuesta": "Escalita"},
    ...
    {"id": 8, "texto_pregunta": "En una escala del 1 al 10, ¿en qué nivel ubicarías su tendencia a aislarse?", "tipo_respuesta": "Escalita"},
    ...
    {"id": 13, "texto_pregunta": "En una escala del 1 al 10, ¿en qué nivel ubicarías tu percepción de riesgo?", "tipo_respuesta": "Escalita"},
    ...
    {"id": 20, "texto_pregunta": "En una escala del 1 al 10, ¿en qué nivel ubicarías tu percepción de riesgo?", "tipo_respuesta": "Escalita"},
    ...
    {"id": 27, "texto_pregunta": "En una escala del 1 al 10, ¿en qué nivel ubicarías tu percepción de riesgo?", "tipo_respuesta": "Escalita"},
    ...
    {"id": 34, "texto_pregunta": "En una escala del 1 al 10, ¿qué tan convencido/a estás de que está en un entorno seguro? (invertida)", "tipo_respuesta": "Escalita"},
]
PLANTILLAS_DATA = [
